package com.example.azzardoclient;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String message = "PUNTATA," + Integer.parseInt(etStake.getText().toString()) +
                    ...
                    if (message != null) {
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (message.startsWith("NOREADY"))
                                    Toast.makeText(getApplicationContext(), "Partita non ancora iniziata", Toast.LENGTH_LONG).show();
                                ...
                                if (message.startsWith("WIN"))
                                    Toast.makeText(getApplicationContext(), "HAI VINTO! " + message.split(",")[1] + "pt", Toast.LENGTH_LONG).show();
